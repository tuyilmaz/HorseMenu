...
namespace YimMenu
{
	...
	void Menu::SetupStyle()
	{
		...
		style.Colors[ImGuiCol_Button]				 = ImVec4(0.62f, 0.055f, 0.055f, 1.00f);
		style.Colors[ImGuiCol_ButtonHovered]		 = ImVec4(0.89f, 0.09f, 0.09f, 1.00f);
		style.Colors[ImGuiCol_ButtonActive]			 = ImVec4(0.761f, 0.071f, 0.071f, 1.00f);
