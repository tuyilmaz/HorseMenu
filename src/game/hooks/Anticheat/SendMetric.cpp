...
namespace YimMenu::Hooks
{
	...
	{
		static auto bad_metrics = std::unordered_set<std::string_view>({"PCSETTINGS", "CHEAT", "WEATHER", "FIRST_VEH", "HARDWARE_OS", "HARDWARE_CPU", "HARDWARE_GPU", "HARDWARE_MOBO", "HARDWARE_MEM", "CASH_CREATED", "PELLETDROPS", "GAMESERVER_TXN_CLAIMLOOT", "GAMESERVER_TXN_AWARDS"});
		char buffer[256]{};
